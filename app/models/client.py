...
if TYPE_CHECKING:
    from app.models.email_config import ClientEmailConfig
...
class Client(Base):
    ...
    email_configs: Mapped[list["ClientEmailConfig"]] = relationship(
        "ClientEmailConfig", back_populates="client", cascade="all, delete-orphan"
    )
